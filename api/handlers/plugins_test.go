...
func (a *mockRepositoryAdapter) UpdateValidationChecks(_ context.Context, _ int64, _ []byte) error {
	return nil
}
...
func (m *mockPluginRepository) UpdateValidationChecks(_ context.Context, _ int64, _ []byte) error {
	return nil
}
