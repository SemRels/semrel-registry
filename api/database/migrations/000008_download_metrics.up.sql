...
CREATE TABLE IF NOT EXISTS metric_daily (
    ...
    CONSTRAINT metric_daily_pk PRIMARY KEY (day, plugin_id, version_id, metric_type)
);
...
CREATE INDEX IF NOT EXISTS idx_metric_daily_plugin_metric_day ON metric_daily(plugin_id, metric_type, day DESC);
CREATE INDEX IF NOT EXISTS idx_metric_daily_version_metric_day ON metric_daily(version_id, metric_type, day DESC);
